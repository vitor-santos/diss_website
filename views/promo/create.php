<div class="container">
	...
	<div class="jumbotron">
		...
		<?php echo form_open('promo/insertPromo'); ?>
		...
		<input type="date" name="launch" class="form-control" value="<?php echo set_value('launch'); ?>"/>
		...
		<input type="date" name="limit" class="form-control" value="<?php echo set_value('limit'); ?>"/>
		<span class="help-block">Neste campo deverá inserir a data de expiração da promoção.</span>
		
		<h5>Descrição (Resumida)</h5>
		<input type="text" name="desc" class="form-control" value="<?php echo set_value('desc'); ?>" size="150" />
		...
		<textarea name="desc_comp" class="form-control" rows="5" cols="50"><?php echo set_value('desc_comp'); ?></textarea>
		...
		<textarea name="cond" class="form-control" rows="4" cols="50"><?php echo set_value('cond'); ?></textarea>
		...
		<h5>Horário</h5>
		<input type="text" name="schedule" class="form-control" value="<?php echo set_value('schedule'); ?>" size="50" />
		...
		<input type="text" name="num" class="form-control" value="<?php echo set_value('num'); ?>" size="50" />
		
		<h5>Preço por Voucher</h5>
		<input type="text" name="price" class="form-control" value="<?php echo set_value('price'); ?>" size="50" />
		...
		<input type="text" name="discount" class="form-control" value="<?php echo set_value('discount'); ?>" size="50" />
		...
		<input type="text" name="dual" class="form-control" value="<?php echo set_value('dual'); ?>" />
